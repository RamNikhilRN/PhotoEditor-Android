package ram.github.io.editor.editimage;
...
import ram.github.io.editor.BaseActivity;
import ram.github.io.editor.R;
import ram.github.io.editor.editimage.fragment.AddTextFragment;
import ram.github.io.editor.editimage.fragment.BeautyFragment;
import ram.github.io.editor.editimage.fragment.BrightnessFragment;
import ram.github.io.editor.editimage.fragment.FilterListFragment;
import ram.github.io.editor.editimage.fragment.MainMenuFragment;
import ram.github.io.editor.editimage.fragment.paint.PaintFragment;
import ram.github.io.editor.editimage.fragment.RotateFragment;
import ram.github.io.editor.editimage.fragment.SaturationFragment;
import ram.github.io.editor.editimage.fragment.StickerFragment;
import ram.github.io.editor.editimage.fragment.crop.CropFragment;
import ram.github.io.editor.editimage.interfaces.OnLoadingDialogListener;
import ram.github.io.editor.editimage.interfaces.OnMainBitmapChangeListener;
import ram.github.io.editor.editimage.utils.BitmapUtils;
import ram.github.io.editor.editimage.utils.PermissionUtils;
import ram.github.io.editor.editimage.view.BrightnessView;
import ram.github.io.editor.editimage.view.CustomPaintView;
import ram.github.io.editor.editimage.view.CustomViewPager;
import ram.github.io.editor.editimage.view.RotateImageView;
import ram.github.io.editor.editimage.view.SaturationView;
import ram.github.io.editor.editimage.view.StickerView;
import ram.github.io.editor.editimage.view.TextStickerView;
import ram.github.io.editor.editimage.view.imagezoom.ImageViewTouch;
import ram.github.io.editor.editimage.view.imagezoom.ImageViewTouchBase;
import ram.github.io.editor.editimage.widget.RedoUndoController;
...
public class EditImageActivity extends BaseActivity implements OnLoadingDialogListener {
    ...
    public static void start(Activity activity, Intent intent, int requestCode) {
        if (TextUtils.isEmpty(intent.getStringExtra(ImageEditorIntentBuilder.SOURCE_PATH))) {
            Toast.makeText(activity, R.string.ram_github_io_editor_not_selected, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void initView() {
        loadingDialog = BaseActivity.getLoadingDialog(this, R.string.ram_github_io_editor_loading,
                false);
        ...
        switch (mode) {
            ...
            default:
                if (canAutoExit()) {
                    ...
                    alertDialogBuilder.setMessage(R.string.ram_github_io_editor_exit_without_save)
                            .setCancelable(false).setPositiveButton(R.string.ram_github_io_editor_confirm, (dialog, id) -> finish()).setNegativeButton(R.string.ram_github_io_editor_cancel, (dialog, id) -> dialog.cancel());
        ...
        Disposable saveImageDisposable = saveImage(mainBitmap)
                ...
                .subscribe(result -> {
                    if (result) {
                        ...
                        showToast(R.string.ram_github_io_editor_save_error);
                    }
                }, e -> showToast(R.string.ram_github_io_editor_save_error));
    ...
    private void loadImageFromFile(String filePath) {
        ...
        Disposable loadImageDisposable = loadImage(filePath)
                ...
                .doOnSubscribe(subscriber -> loadingDialog.show())
                .doFinally(() -> loadingDialog.dismiss())
                .subscribe(processedBitmap -> changeMainBitmap(processedBitmap, false), e -> showToast(R.string.ram_github_io_editor_load_error));
