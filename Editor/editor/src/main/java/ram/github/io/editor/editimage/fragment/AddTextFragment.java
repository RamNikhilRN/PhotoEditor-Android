...
import ram.github.io.editor.editimage.ModuleConfig;
import ram.github.io.editor.editimage.gesture.MultiTouchListener;
import ram.github.io.editor.editimage.interfaces.OnGestureControl;
import ram.github.io.editor.editimage.interfaces.OnMainBitmapChangeListener;
import ram.github.io.editor.editimage.interfaces.OnMultiTouchListener;
import ram.github.io.editor.editimage.interfaces.OnPhotoEditorListener;
import ram.github.io.editor.editimage.layout.ZoomLayout;
        ...
        Disposable applyTextDisposable = Observable.fromCallable(() -> getFinalBitmapFromView(textStickersParentView))
                ...
                .subscribe(
                        ...
                        e -> {
                            e.printStackTrace();
                            backToMain();
                            Toast.makeText(getContext(), getString(R.string.ram_github_io_editor_save_error), Toast.LENGTH_SHORT).show();
                        });
