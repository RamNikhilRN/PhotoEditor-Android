...
import ram.github.io.editor.editimage.adapter.viewholders.FilterViewHolder;
...
public class FilterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FilterAdapter(FilterListFragment fragment, Context context) {
        ...
        filters = filterListFragment.getResources().getStringArray(R.array.ram_github_io_editor_filters);
        filterImages = filterListFragment.getResources().getStringArray(R.array.ram_github_io_editor_filter_drawable_list);
    }
